...
insert into authorities (authorities.user_id,authorities.authority) values (1,'ROLE_USER');
insert into authorities (authorities.user_id,authorities.authority) values (2,'ROLE_USER');
insert into authorities (authorities.user_id,authorities.authority) values (2,'ADMIN_USER');